  ...
  return (
    <NextIntlClientProvider>
      <SiteHeader
        ...
        labels={{ home: t('home'), inquiry: t('inquiry'), login: t('login'), signup: t('signup'), mypage: t('mypage'), logout: t('logout'), admin: t('admin'), chatLoginBody1: tChat('loginBody1'), chatLoginBody2: tChat('loginBody2') }}
      />
      {children}
