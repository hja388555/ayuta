...
export type GuestStartValues = { name: string; email: string; phone: string; phoneCountry: PhoneCountry; consent: boolean }
export type GuestStartErrors = Partial<Record<'name' | 'email' | 'phone' | 'consent', 'required' | 'email' | 'phone' | 'consent_required'>>
