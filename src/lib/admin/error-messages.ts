...
const MESSAGES: Record<string, string> = {
  ...
  contract_required: '계약서 제목과 본문을 모두 입력해 주세요. 발행하면 이 문구가 그대로 고정됩니다.',
  consent_required: '고객이 체크할 동의 항목이 최소 한 줄 필요하고, 그중 하나는 필수여야 합니다.',
  consent_invalid: '동의 항목의 문구를 한국어·일본어 모두 입력해 주세요.',
  consent_duplicate: '동의 항목이 겹칩니다. 같은 항목을 두 번 넣을 수 없습니다.',
